...
class Ui_LabelImg(object):
    def setupUi(self, LabelImg):
        ...
        # LabelImg.resize(1604, 959)
        LabelImg.setFixedSize(1604, 959)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 190, 1069))
        ...
        self.zoomIn = QtWidgets.QPushButton(self.groupBox_2)
        self.zoomIn.setMinimumSize(QtCore.QSize(0, 50))
        self.zoomIn.setMaximumSize(QtCore.QSize(16777215, 50))
        ...
        self.verticalLayout_4.addWidget(self.zoomIn)
        self.zoomOut = QtWidgets.QPushButton(self.groupBox_2)
        self.zoomOut.setMinimumSize(QtCore.QSize(0, 50))
        ...
        self.verticalLayout_4.addWidget(self.zoomOut)
        ...
        self.CreateBBoxButton_2 = QtWidgets.QPushButton(self.groupBox)
        self.CreateBBoxButton_2.setMinimumSize(QtCore.QSize(0, 50))
        self.CreateBBoxButton_2.setMaximumSize(QtCore.QSize(16777215, 50))
        self.CreateBBoxButton_2.setObjectName("CreateBBoxButton_2")
        self.verticalLayout_2.addWidget(self.CreateBBoxButton_2)
    ...
    def retranslateUi(self, LabelImg):
        ...
        self.CreateBBoxButton_2.setText(_translate("LabelImg", "draw Interaction"))
...
"W -- Create RectBox   D -- Next Image     A -- Prev Image   S -- Save Label   Esc -- Cancle RectBox    Del(After Select Image Path) --  Delete Saved Label"))
        ...
        self.label_15.setText(_translate("LabelImg", "frame:"))
